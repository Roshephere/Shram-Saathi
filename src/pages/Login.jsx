    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 sm:p-8">
      <div className="w-full max-w-5xl bg-white rounded-[2rem] shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[700px]">
        ...
        <div className="hidden md:block md:w-1/2 relative">
          <img
            src="https://plus.unsplash.com/premium_photo-1678766818764-406904b56d82?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="Professional"
          ...
          <div className="absolute bottom-0 left-0 p-12">
            ...
            <p className="text-lg text-white/90 font-medium">Your Next Job is Closer Than You Think. <br /> Sign in to get personalized job recommendations that match your exact skills, location, and experience.</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-white">
          <div className="max-w-sm mx-auto w-full">
            ...
            <p className="text-gray-500 mt-2 text-sm font-medium">Sign in to continue to ShramSaathi</p>
            ...
            <div className="flex p-1 bg-gray-100 rounded-xl mt-8 mb-6">
              <button
                ...
                className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${role === 'user'
              ...
              <button
                ...
                className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${role === 'merchant'
                  ? 'bg-white text-gray-900 shadow-sm'
                  : 'text-gray-500 hover:text-gray-700'
                  }`}
              >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label htmlFor="password" className="block text-xs font-bold text-gray-800 tracking-wide">
                    Password
                  </label>
                  <a href="#" className="text-xs font-bold text-gray-900 underline hover:text-gray-600 transition-colors">
                    Forgot Password?
                  </a>
                </div>
                <div className="relative">
